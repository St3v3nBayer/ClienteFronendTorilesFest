...
import { faUserPlus, faRetweet, faRotateLeft } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="container mt-5 w-75">
            <Form onSubmit={handleSubmit}>
                    ...
                    if (variableCU === 1) {
                        return (
                            <Button variant="success" size="lg" type="submit">
                                <FontAwesomeIcon icon={faUserPlus} size="lg" fixedWidth color="white" />
                                <h6>Crear</h6>
                            </Button>
                        )
                    } else {
                        return (
                            <Button onClick={() => { handleActualizarUsuario(form) }} size="lg" variant="success">
                ...
                {" "}
                <Button variant="dark" size="lg" onClick={handleCancelUpdateCreateUser}>
